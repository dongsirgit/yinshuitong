...
public class WXBizMsgCrypt {
    ...
    public String EncryptMsg(String replyMsg, String timeStamp, String nonce) throws AesException {
        ...
        // 各元素排序后加密
        String signature = StringUtils.hashCode(StringUtils.sortString(token, timeStamp, nonce, encrypt), false);
    ...
    public String DecryptMsg(String msgSignature, String timeStamp, String nonce, String postData) throws AesException {
        ...
        // 验证安全签名
        String signature = StringUtils.hashCode(StringUtils.sortString(token, timeStamp, nonce, encrypt[1].toString()),
                false);
    ...
    public String VerifyURL(String msgSignature, String timeStamp, String nonce, String echoStr) throws AesException {
        ...
        String signature = StringUtils.hashCode(StringUtils.sortString(token, timeStamp, nonce, echoStr), false);
        if (!signature.equals(msgSignature)) {
            throw new AesException(AesException.ValidateSignatureError);
        }
