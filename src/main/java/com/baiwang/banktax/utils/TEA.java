...
//		String str = "美好生活";
		//String value = java.net.URLEncoder.encode(str, "utf-8");
		//System.out.println(TEA.Encrypt(str));
		//String str2 = java.net.URLDecoder.decode(TEA.Decrypt("8e28d4a7d97bec3e1aacb2edaf0479ab59aa9d4c19d090869afc44845bcaec2a8e108da61e8d5966"), "utf-8");
//		System.out.println(TEA.Decrypt(TEA.Encrypt(str)));
		//System.out.println(TEA.Decrypt("2efe742b0a190090"));
