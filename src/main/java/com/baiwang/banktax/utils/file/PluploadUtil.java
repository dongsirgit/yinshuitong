...
/**
  ...
  * @Description: plupload上传工具类
  * @author ldm
  * @date 2015年9月1日 上午11:57:07
  */
public class PluploadUtil {  
     ...
     * @throws IOException 
     */  
    public static String upload(long uid ,Plupload plupload, File dir) throws  Exception {  
        //生成唯一的文件名  
        String filename = uid +"_"+ System.currentTimeMillis() +"_"+ plupload.getName();
//        String filename = "" + plupload.getName();
     ...
     * @throws IOException 
     */  
    public static void upload(Plupload plupload, File dir, String filename) throws  Exception {  
        ...
        if(map != null) {  
            ...
            while(iter.hasNext()) {  
                ...
                for(MultipartFile multipartFile : fileList) {  
                    ...
                    //创建新目标文件  
                    File targetFile = new File(dir.getPath()+ Constant.FILE_SEPARAROR + filename);  
                      
                    //当chunks>1则说明当前传的文件为一块碎片，需要合并  
                    if (chunks > 1) {  
                        //需要创建临时文件名，最后再更改名称  
                        File tempFile = new File(dir.getPath()+ Constant.FILE_SEPARAROR + multipartFile.getName());  
