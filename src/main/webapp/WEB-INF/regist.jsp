        ...
        <div class="wrap_629">
            <div class="content">
                ...
                <form action="<%=basePath%>/user/register" method="post" id="myform" onsubmit="return register()">
                    <div class="form-item ">
                        <label>手机号</label>
                        <input type="text" class="inputState" id="mobilePhone" style="color:#b0b0b0;" name="mobilePhone" value="请输入手机号" onblur="checkMobilePhone()" />
                    ...
                    <div class="form-item" style="width:240px;padding-right:0">
                        <label>验证码</label>
                        <input type="text" class="inputState" id="phoneCode" style="color:#b0b0b0;width:148px" name="phoneCode" value="请输入验证码" onblur="checkPhoneCode()" disabled="disabled" />
