		...
		<div class="forget">
			<div class="forget_con">
				...
				<div class="hg">
                    ...
                    <input type="password" class="pwdState" id="userPwd1_hidden" style="color:#000; display:none" value="" onblur="checkPwd1()" onkeyup="if(this.value.length>16){this.value=this.value.substr(0,16)};" />
				...
				<div class="hg" style="margin-top:10px">
                    ...
                    <input type="password" class="pwdState" id="userPwd2_hidden" style="color: #000; display: none" onblur="checkPwd2()" value="" onkeyup="if(this.value.length>16){this.value=this.value.substr(0,16)};" />
