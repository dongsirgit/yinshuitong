				...
				<li class="current">
					...
					<form action="" method="post" id="myform">
						<div class="change_password">
							<div class=" form-item ">
								<label>原密码</label>
                                <input type="password" name="userPass" id="userPass" style="color: #b0b0b0;" onblur="check_UserPass();" />
							</div>
							<div class="info">
							...
							<div class=" form-item">
								<label>新密码</label>
								<input type="text" name="passWord" id="passWord" style="color: #b0b0b0;" value="(6-20位的大小写字母、数字)" onblur="check_PassWord();changepass();" />
							</div>
							<div class="info">
